...
class KanbanActions extends React.Component {
  render() {
    ...
    var theNode = data1.map(function(dataItems) {
      return (
        <KanbanActions title={dataItems.title} author={dataItems.author} key={dataItems.id}/>
        )
    });
...
class KanbanActions2 extends React.Component {
  render() {
    var theNode = data2.map(function(dataItems) {
      return (
        <KanbanActions2 title={dataItems.title} author={dataItems.author} key={dataItems.id}/>
        )
